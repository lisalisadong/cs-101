...
def involved(courses, person):
    ...
    for hexamester in courses:
        course = []
        for c in courses[hexamester]:
            if 'teacher' in courses[hexamester][c] and courses[hexamester][c]['teacher'] == person:
                course.append(c)
            if 'assistant' in courses[hexamester][c] and courses[hexamester][c]['assistant'] == person:
                course.append(c)
        if course != []:
